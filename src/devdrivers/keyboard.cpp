...
const KeyboardLayout USLayout {
  ...
  // single byte scancodes
  {
    ...
    { 0x61, VK_INTL_BACKSLASH }, // Extra key on 105 keyboards (typically Intl not US) required here for USB backtrack
  },
...
const KeyboardLayout FrenchLayout {
  ...
  //  in_key, { CTRL, ALT, SHIFT, CAPSLOCK, NUMLOCK }, out_key
  {
    { VK_AMPERSAND,   { 0, 0, 1, 0, 0 }, VK_1 },            // SHIFT "&" = "1"
    { VK_ACUTE_e,     { 0, 0, 1, 0, 0 }, VK_2 },            // SHIFT "é" = "2"
    { VK_QUOTEDBL,    { 0, 0, 1, 0, 0 }, VK_3 },            // SHIFT """ = "3"
    { VK_QUOTE,       { 0, 0, 1, 0, 0 }, VK_4 },            // SHIFT "'" = "4"
    { VK_LEFTPAREN,   { 0, 0, 1, 0, 0 }, VK_5 },            // SHIFT "(" = "5"
    { VK_MINUS,       { 0, 0, 1, 0, 0 }, VK_6 },            // SHIFT "-" = "6"
    { VK_GRAVE_e,     { 0, 0, 1, 0, 0 }, VK_7 },            // SHIFT "è" = "7"
    { VK_UNDERSCORE,  { 0, 0, 1, 0, 0 }, VK_8 },            // SHIFT "_" = "8"
    { VK_CEDILLA_c,   { 0, 0, 1, 0, 0 }, VK_9 },            // SHIFT "ç" = "9"
    ...
    { VK_ASTERISK,    { 0, 0, 1, 0, 0 }, VK_MICRO },        // SHIFT "*" = "µ"
    { VK_LESS,        { 0, 0, 1, 0, 0 }, VK_GREATER },      // SHIFT "<" = ">"
    { VK_COMMA,       { 0, 0, 1, 0, 0 }, VK_QUESTION },     // SHIFT "," = "?"
    { VK_SEMICOLON,   { 0, 0, 1, 0, 0 }, VK_PERIOD },       // SHIFT ";" = "."
    { VK_COLON,       { 0, 0, 1, 0, 0 }, VK_SLASH },        // SHIFT ":" = "/"
    { VK_EXCLAIM,     { 0, 0, 1, 0, 0 }, VK_SECTION },      // SHIFT "!" = "§"

    { VK_ACUTE_e,     { 0, 1, 0, 0, 0 }, VK_TILDE },        // ALT "é"   = "~"
    { VK_QUOTEDBL,    { 0, 1, 0, 0, 0 }, VK_HASH },         // ALT """   = "#"
    { VK_QUOTE,       { 0, 1, 0, 0, 0 }, VK_LEFTBRACE },    // ALT "'"   = "{"
    { VK_LEFTPAREN,   { 0, 1, 0, 0, 0 }, VK_LEFTBRACKET },  // ALT "("   = "["
    { VK_MINUS,       { 0, 1, 0, 0, 0 }, VK_VERTICALBAR },  // ALT "-"   = "|"
    { VK_GRAVE_e,     { 0, 1, 0, 0, 0 }, VK_GRAVEACCENT },  // ALT "è"   = "`"
    { VK_UNDERSCORE,  { 0, 1, 0, 0, 0 }, VK_BACKSLASH },    // ALT "_"   = "\"
    { VK_CEDILLA_c,   { 0, 1, 0, 0, 0 }, VK_CARET },        // ALT "ç"   = "^"
    { VK_GRAVE_a,     { 0, 1, 0, 0, 0 }, VK_AT },           // ALT "à"   = "@"
    { VK_RIGHTPAREN,  { 0, 1, 0, 0, 0 }, VK_RIGHTBRACKET }, // ALT ")"   = "]"
    { VK_EQUALS,      { 0, 1, 0, 0, 0 }, VK_RIGHTBRACE },   // ALT "="   = "}"
    { VK_e,           { 0, 1, 0, 0, 0 }, VK_EURO },         // ALT "e"   = "€"
    { VK_DOLLAR,      { 0, 1, 0, 0, 0 }, VK_CURRENCY },     // ALT "$"   = "¤"
  }
};
...
const KeyboardLayout SwedishLayout {
  ...
  //  in_key, { CTRL, ALT, SHIFT, CAPSLOCK, NUMLOCK }, out_key
  {
    { VK_a_RING,      { 0, 0, 1, 1, 0 }, VK_A_RING },       // SHIFT "å" = "Å"
    { VK_UMLAUT_o,    { 0, 0, 1, 1, 0 }, VK_UMLAUT_O },     // SHIFT "ö" = "Ö"
    { VK_UMLAUT_a,    { 0, 0, 1, 1, 0 }, VK_UMLAUT_A },     // SHIFT "ä" = "Ä"
    { VK_SECTION,     { 0, 0, 1, 0, 0 }, VK_HALF },         // SHIFT "§" = "½"
    { VK_2,           { 0, 0, 1, 0, 0 }, VK_QUOTEDBL },     // SHIFT "2" = """
    { VK_4,           { 0, 0, 1, 0, 0 }, VK_CURRENCY },     // SHIFT "4" = "¤"
    ...
    { VK_PLUS,        { 0, 0, 1, 0, 0 }, VK_QUESTION },     // SHIFT "+" = "?"
    { VK_ACUTEACCENT, { 0, 0, 1, 0, 0 }, VK_GRAVEACCENT },  // SHIFT "´" = "`"
    { VK_DIAERESIS,   { 0, 0, 1, 0, 0 }, VK_CARET },        // SHIFT "¨" = "^"
    { VK_QUOTE,       { 0, 0, 1, 0, 0 }, VK_ASTERISK },     // SHIFT "'" = "*"
    { VK_LESS,        { 0, 0, 1, 0, 0 }, VK_GREATER },      // SHIFT "<" = ">"
    ...
    { VK_3,           { 0, 1, 0, 0, 0 }, VK_POUND },        // ALT "3"   = "£"
    { VK_4,           { 0, 1, 0, 0, 0 }, VK_DOLLAR },       // ALT "4"   = "$"
    { VK_5,           { 0, 1, 0, 0, 0 }, VK_EURO },         // ALT "5"   = "€"
    ...
    { VK_PLUS,        { 0, 1, 0, 0, 0 }, VK_BACKSLASH },    // ALT "+"   = "\"
    { VK_DIAERESIS,   { 0, 1, 0, 0, 0 }, VK_TILDE },        // ALT "¨"   = "~"
...
{
  setLEDs(m_NUMLOCK, m_CAPSLOCK, m_SCROLLLOCK);
...
char const * Keyboard::virtualKeyToString(VirtualKey virtualKey)
{
  char const * VKTOSTR[] = { "VK_NONE", "VK_SPACE", "VK_0", "VK_1", "VK_2", "VK_3", "VK_4", "VK_5", "VK_6", "VK_7", "VK_8", "VK_9", "VK_KP_0", "VK_KP_1", "VK_KP_2",
                             ...
                             "VK_SCROLLLOCK", "VK_NUMLOCK", "VK_CAPSLOCK", "VK_TAB", "VK_RETURN", "VK_KP_ENTER", "VK_INTL_BACKSLASH", "VK_APPLICATION", "VK_PAGEUP", "VK_KP_PAGEUP", "VK_PAGEDOWN", "VK_KP_PAGEDOWN", "VK_UP", "VK_KP_UP",
